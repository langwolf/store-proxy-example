...
@Component(IRedisDao.COMMON_REDIS)
public class RedisDao extends AbstractRedisClusterDao implements IRedisDao {
    private static final Logger logger = LoggerFactory.getLogger(RedisDao.class);


    @Autowired
    public RedisDao(@Qualifier(RedisConstants.COMMON_REDIS) JedisCluster jedisCluster){
